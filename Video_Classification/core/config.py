...
__C.MODEL = AttrDict()
__C.MODEL.CLASSIFICATION_TYPE = str('ml')  # either multi-label 'ml' or single-label 'sl'
__C.MODEL.N_CLASSES = 10  # how many classes as output
...
__C.MODEL.BACKBONE_CNN = str('vgg')  # which backbone cnn is used
__C.MODEL.BACKBONE_FEATURE = str('pool5')  # type of feature output from backbone cnn
